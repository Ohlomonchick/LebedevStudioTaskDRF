    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_year', models.CharField(null=True)),
                ('keywords', models.TextField(default='')),
                ('composer', models.ManyToManyField(null=True, related_name='song_composer', to='db_api.composer')),
                ('genre', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='db_api.genre')),
                ('text_author', models.ManyToManyField(null=True, related_name='song_text_author', to='db_api.textauthor')),
